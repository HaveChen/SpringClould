<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="reportAssembleResourceList" @selection-change="handleSelectionChange">
...
<script>
import { listReportAssembleResource, getReportAssembleResource, delReportAssembleResource, addReportAssembleResource, updateReportAssembleResource, exportReportAssembleResource } from "@/api/reportOnline/reportAssembleResource";
