<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cltExtensionFieldList" @selection-change="handleSelectionChange">
...
<script>
import { listCltExtensionField, getCltExtensionField, delCltExtensionField, addCltExtensionField, updateCltExtensionField, exportCltExtensionField } from "@/api/collection/cltExtensionField";
